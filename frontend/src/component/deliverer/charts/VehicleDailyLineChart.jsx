...
const VehicleDailyLineChart = ({
  ...
  const [formattedData] = useMemo(() => {
    if (!vehicleStats) return []; // Add a check for vehicleStats

    const { dailyData } = vehicleStats;
    const totalJobsLine = {
      id: "totalJobs",
  ...
  }, [vehicleStats, startDate, endDate]); // eslint-disable-line react-hooks/exhaustive-deps
...
export default VehicleDailyLineChart;
