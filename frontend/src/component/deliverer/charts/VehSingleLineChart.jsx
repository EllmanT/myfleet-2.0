...
const VehSingleLineChart = ({ isDashboard = false, view , vehicleId }) => {
  ...
  }, [vehicleStats, selectedYear]); // eslint-disable-line react-hooks/exhaustive-deps
...
export default VehSingleLineChart;
