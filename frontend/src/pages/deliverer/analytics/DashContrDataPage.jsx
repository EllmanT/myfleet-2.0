...
import ContrDailyLineChart from "component/deliverer/charts/ContrDailyLineChart";
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Box display="flex">
        ...
        <Header
          title="DAILY JOBS INFO FOR THE cONTRACTOR"
          subtitle="Chart of daily jobs and revenue"
        />
      </Box>
      <Button
        variant="outlined"
      ...
      <Box height="75vh" id="print-content">
        ...
        <ContrDailyLineChart contractorId={contractorId} />
      </Box>
    </Box>
  );
};

export default DashContrDataPage;
